      ...
      <div>
        ...
        <div className="flex flex-col gap-4 mt-4">
          <fieldset className="fieldset gap-1">
            ...
            {errors.employeeId && (
              <p data-testid="error-employeeId" className="text-error text-xs">
                {errors.employeeId}
              </p>
            )}
          </fieldset>
          ...
          <fieldset className="fieldset gap-1">
            ...
            <div className="flex flex-wrap gap-2 border border-base-300 rounded-lg p-3">
              {employees.map((e) => {
                const checked = s1.employeeIds.includes(e.id)
                return (
                  <label
                    key={e.id}
        ...
        <div className="flex flex-col gap-4 mt-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <fieldset className="fieldset gap-1">
                  ...
                  <input
                    ...
                    type="time"
                    className="input input-bordered w-full"
                    value={s2.carPickupTime}
                    onChange={(e) => setS2((p) => ({ ...p, carPickupTime: e.target.value }))}
                  />
                </fieldset>
                <fieldset className="fieldset gap-1">
                  <label
                  ...
                  <input
                    ...
                    type="time"
                    className="input input-bordered w-full"
                    value={s2.carReturnTime}
                    onChange={(e) => setS2((p) => ({ ...p, carReturnTime: e.target.value }))}
                  />
                </fieldset>
              </div>
              <fieldset className="fieldset gap-1">
                ...
                <input
                  ...
                  className="input input-bordered w-full"
                  value={s2.carPickupAddress}
                  onChange={(e) => setS2((p) => ({ ...p, carPickupAddress: e.target.value }))}
                />
              </fieldset>
            </div>
          )}
          ...
          <fieldset className="fieldset gap-1">
            ...
            <input
              ...
              type="text"
              className="input input-bordered w-full"
              value={s2.serviceAddress}
              onChange={(e) => setS2((p) => ({ ...p, serviceAddress: e.target.value }))}
            />
          </fieldset>
          ...
          <div className="grid grid-cols-2 gap-4">
            <fieldset className="fieldset gap-1">
              ...
              <input
                ...
                type="text"
                className="input input-bordered w-full"
                value={s2.clientContactName}
                onChange={(e) => setS2((p) => ({ ...p, clientContactName: e.target.value }))}
              />
            </fieldset>
            <fieldset className="fieldset gap-1">
              <label
              ...
              <input
                ...
                type="text"
                className="input input-bordered w-full"
                value={s2.clientContactPhone}
                onChange={(e) => setS2((p) => ({ ...p, clientContactPhone: e.target.value }))}
              />
            </fieldset>
          </div>
        ...
        <div className="flex flex-col gap-4 mt-4">
          ...
          <fieldset className="fieldset gap-1">
            ...
            <select
              ...
              className="select select-bordered w-full"
              value={s3.bagId}
              onChange={(e) => setS3((p) => ({ ...p, bagId: e.target.value }))}
            >
              <option value="">Selecione...</option>
              {bags.map((b) => (
          ...
          <fieldset className="fieldset gap-1">
            ...
            <textarea
              ...
              rows={2}
              value={s3.scopeDetail}
              onChange={(e) => setS3((p) => ({ ...p, scopeDetail: e.target.value }))}
            />
          </fieldset>
      ...
      <div data-testid="review-step" className="mt-4 flex flex-col gap-4">
        <div className="card bg-base-200 p-4">
          ...
          <p>
            ...
            {employees.find((e) => e.id === s1.employeeId)?.name ?? s1.employeeId}
          </p>
          <p>
        ...
        <div className="card bg-base-200 p-4">
          ...
          <p>
            ...
            {s3.jobType === 'maintenance' ? 'Manutenção' : 'Implementação'}
          </p>
          <p>
            <span className="font-medium">Descrição:</span> {s3.description}
          </p>
          {s3.notes && (
            <p>
