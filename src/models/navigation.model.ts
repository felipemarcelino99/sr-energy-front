...
export const NAV_ITEMS: NavItem[] = [
  ...
  { label: 'OS', path: '/jobs', icon: 'briefcase', allowedRoles: ['admin', 'manager'] },
  ...
  { label: 'Malas', path: '/bags', icon: 'briefcase', allowedRoles: ['admin', 'manager'] },
  ...
  { label: 'Minhas OS', path: '/my-jobs', icon: 'clipboard', allowedRoles: ['employee'] },
